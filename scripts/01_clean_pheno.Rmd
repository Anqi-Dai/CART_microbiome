...
phe_M <- read_excel('/Volumes/castoricenter/CAR-Tcell_and_Microbiota/CTC Event Table 10222019.xlsx',
                    sheet = 5)
```
...
have_sg <- read_csv('../data/baselinesforAngel10032019.csv') %>% 
  ...
  # 171 is back, removing the the other two that doesn't make to the final valid sample
  filter(!sample_id %in% c('161','173'))
