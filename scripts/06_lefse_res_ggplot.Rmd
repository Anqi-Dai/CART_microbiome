...
feature %>% 
  ...
  labs(title = str_glue('Response to class (with subclass): {.$group}') ,
       y = 'Score')+ 
  ggsave(str_glue('/Volumes/castoricenter/CAR-Tcell_and_Microbiota/humann2_shotgun/figs/lefse_results_ggplot_recreate/Response to class (with subclass): {.$group}.pdf'), device = 'pdf', width = 15, height = 6, dpi = 300))
