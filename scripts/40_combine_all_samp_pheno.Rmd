...
all_pheno <- read_csv('../data/shotgun_pheno/final_comprehensive.csv')
```

```{r}
# as the CR we currently want to look at the day 100 respone only
all_pheno %>% 
  select(fid, cr_d100, toxicity, center) %>% 
  write_csv('../data/shotgun_pheno/final_simplified.csv')
```
